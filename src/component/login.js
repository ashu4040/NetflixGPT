  ...
  return (
    <div className="">
      ...
      <form
        ...
        className="absolute w-full md:w-3/12 m-10 p-12 mx-auto right-0 left-0 my-40 opacity-90 bg-black rounded-lg"
      >
        <h1 className="text-white font-bold m-2 my-5 text-2xl md:text-3xl">
